...
.input-group{
    ...
    <body style="background: url(../images/1.jpeg)  center;background-size: cover; ">
           ...
           ost =(OraclePreparedStatement) oconn.prepareStatement("SELECT * FROM users where email=?");
            ...
            if(request.getParameter("bVerify")!=null)
            {
                ...
                <script>
                    ...
                    location.href="http://localhost:8080/cruise_booking_system/frontend/NewPassword.jsp?pemail=<%=vemail%>";
                </script>
                <%
                }
                else
        ...
        <form name="frmSecurity" method="POST" action="http://localhost:8080/cruise_booking_system/frontend/VerifyQues.jsp?pemail=<%=vemail%>">
          <div class="form-box">
