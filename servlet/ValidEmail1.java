...
public class ValidEmail1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           ost =(OraclePreparedStatement) oconn.prepareStatement("SELECT * FROM users where email=?");
            ...
            final String username ="pearlcruiseline@gmail.com";
		final String password = "kfbbwnhrwfrtpdck";
		...
		props.put("mail.smtp.port", "587");
            ...
            try {
                    ...
                    vbody += "http://localhost:8080/MAJOR_PROJECT/frontend/VerifyQues.jsp?pemail="+vemail;
                    message.setText(vbody);
                    Transport.send(message);
                    response.sendRedirect("http://localhost:8080/MAJOR_PROJECT/frontend/ForgotClose.html");
            ...
            {
                response.sendRedirect("http://localhost:8080/MAJOR_PROJECT/frontend/WrongEmail.html");
            }
            ost.close();
            oconn.close();
            out.println("</body>");
            ...
            out.println("</html>");
                  ...
                  Logger.getLogger(ValidEmail1.class.getName()).log(Level.SEVERE, null, ex);
              }
    }
